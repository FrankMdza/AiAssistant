...
class ProjectsAgent:
    def __init__(self):
        ...
        STYLE: Methodical, organized, focused on deliverables. Use 🏗️, 📅, ✅.
        ...
        - **Milestones** (formatted as `### 🚩 Milestone: Name`)
        """
    ...
    def create_project_with_plan(self, name: str, objective: str) -> str:
        """
        The Brain 🧠: Creates a project file and uses LLM to generate a plan.
        ...
        try:
            ...
            logger.info(f"🧠 PM Planning Project: {name}")
...
"""
            ...
            return f"Project '{name}' created and planned. First task '{first_task}' added to Inbox. 🏗️"
    ...
    def review_inbox(self) -> str:
        ...
        try:
            ...
            if count == 0:
                return "Inbox Zero! You have no pending tasks. 🎉"
    ...
    def generate_weekly_sprint(self, project_name: str) -> str:
        ...
        try:
            ...
            logger.info(f"🧠 Generating Sprint for: {project_name}")
            response = self.model.generate_content(prompt)
